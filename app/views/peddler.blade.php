...
@section('content')
    <main>
        <div class="center-align container">
            ...
            <p>
                Peddler's Corner is full-stack modified Craigslist clone completed in a group of three people as part of the Codeup program. The sites uses Twitter Bootstrap and CSS for styling, and PHP and MySQL for functionality and database management. I was responsible for site design and user interface, as well as sharing back-end and database tasks.
            </p>
            <p>
